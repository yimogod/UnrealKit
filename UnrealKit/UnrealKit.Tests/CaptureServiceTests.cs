...
public sealed class CaptureServiceTests : IDisposable
{
    ...
    private sealed class FakeDeviceService : IDeviceService
    {
        ...
        public Task<ProcessExecutionResult> StartApplicationAsync(IDevice device, string target, string? activity = null, string? commandLineArguments = null, IProgress<OperationProgress>? progress = null, CancellationToken cancellationToken = default) => Task.FromResult(Result());
        ...
        public Task<ProcessExecutionResult> TakeScreenshotAsync(IDevice device, string localPath, IProgress<OperationProgress>? progress = null, CancellationToken cancellationToken = default) => Task.FromResult(Result());
    }
}
